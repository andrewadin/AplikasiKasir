                            ...
                            <div class="body">
                                <table class="table table-striped">
                                    ...
                                    <tbody class="addMoreProduct">
                                        <tr>
                                            ...
                                            <td><input class="form-control stk" type="number" name="stk[]" id="stk"
                                                    required></td>
                                            ...
                                            <td><input class="form-control diskon" type="number" name="diskon[]"
                                                    id="diskon" required min="0" max="100"
                                                    onKeyPress="if(this.value.length==3) return false;" value="0"></td>
                                            <td><div class="input-group mb-2">
                                                    <div class="input-group-prepend">
                                                        <span class="input-group-text" style="font-size:12px;">Rp</span>
                                                    </div>
                                                <input class="form-control total_item" type="text" name="total[]"
                                                    id="total_item" required></div></td>
                                            <td></td>
                                        </tr>
                                    </tbody>
                                ...
                                <div class="card" style="width: 18rem;">
                                    ...
                                    <ul class="list-group list-group-flush">
                                        <li class="list-group-item"> Total = Rp. <b class="total" id="total"> 0</b>
                                        </li>
                                        ...
                                        <li class="list-group-item"><button type="submit" class="btn btn-primary"
                                                onclick="return confirm('Apakah anda yakin sudah yakin ?')">Bayar</button>
                                        </li>
                                    </ul>
                                </div>
