                            ...
                            <table class="table table-hover js-basic-example dataTable table-custom">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>@foreach ($outer as $tags)<?php $id = $tags->id ?> @endforeach <a href="{{route('kprintNota',$id)}}" class="btn btn-success"><i class="fa fa-address-book" aria-hidden="true"></i> Print Nota</a></td>
                                    </tr>
                                    @endforeach
                                </tbody>
                            </table>
