                        ...
                        <div class="body">
                            <form id="basic-form" method="post" action="{{ route('barang-store') }}">
                                ...
                                <div class="input-group mb-3">
                                    ...
                                    <input type="number" class="form-control" name="buy_price" placeholder="Ex: 1.000,00 Rp" id="buy_price">
                                </div>
                                ...
                                <div class="input-group mb-3">
                                    ...
                                    <input type="number" class="form-control" name="sell_price" placeholder="Ex: 1000,00 Rp" id="sell_price">
                                </div>
                                <br>
